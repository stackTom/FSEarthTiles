    ...
    public class TileCodeingScript
    {
        ...
        public String MapAreaCoordToTileCode(Int64 iAreaCodeX, Int64 iAreaCodeY, Int64 iAreaCodeLevel, String iUseCode)
        {
            ...
            else if (EarthCommon.StringCompare(iUseCode, "lxy"))
            {
                ...
                {
                    case 19:
                        vServiceY = vServiceY - 118846;
                        break;
                    case 18:
                        vServiceY = vServiceY - 59243;
                        break;
                    case 17:
                        vServiceY = vServiceY - 29711;
                        break;
                    case 16:
                        vServiceY = vServiceY - 16779;
                        break;
                    case 15:
                        vServiceY = vServiceY - 8389;
                        break;
                    case 14:
                        vServiceY = vServiceY - 4194;
                        break;
                    case 13:
                        vServiceY = vServiceY - 2097;
                        break;
                    case 12:
                        vServiceY = vServiceY - 1049;
                        break;
                    case 11:
                        vServiceY = vServiceY - 525;
                        break;
                    case 10:
                        vServiceY = vServiceY - 262;
                        break;
