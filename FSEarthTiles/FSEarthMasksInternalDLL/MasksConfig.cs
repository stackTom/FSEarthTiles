...
namespace FSEarthMasksInternalDLL
{
    public class MasksConfig
    {
        ...
        public static Boolean useAutomaticWaterMasking = true;
        ...
        private static void AnalyseConfigFile()
        {
            for (Int32 vRow = 0; vRow < mFSEarthMasksConfigFileList.Count; vRow++)
            {
                ...
                Int32 vIndex440 = vFocus.IndexOf("use_automatic_water_masking", StringComparison.CurrentCultureIgnoreCase);
                ...
                {
                    String vCutString = GetRightSideOfConfigString(vFocus);
                    useAutomaticWaterMasking = GetBooleanFromString(vCutString);
                }
            }
        }
        ...
        private static void AnalyseAreaEarthInfoFile()
        {
            for (Int32 vRow = 0; vRow < mAreaEarthInfoFileList.Count; vRow++)
            {
                ...
                Int32 vIndex32 = vFocus.IndexOf("SkipAllWaterTiles", StringComparison.CurrentCultureIgnoreCase);
                ...
                {
                    String vCutString = GetRightSideOfConfigString(vFocus);
                    skipAllWaterTiles  = GetBooleanFromString(vCutString);
                }
            }
        }
